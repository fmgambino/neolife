      ...
      <q-card class="q-pa-md">
        ...
        <div class="row q-pb-lg" style="width: 100%">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-xs">
            ...
            <q-input v-if="!editForm" :error="$v.form.verifyPassword.$error" error-message="Este campo es requerido" outlined dense v-model="form.verifyPassword" placeholder="Introducir contraseña" />
          </div>
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-xs">
            <div>Perfil</div>
            ...
            <div class="q-mt-sm" >Iglesias</div>
            <q-select :error="$v.form.church.$error" error-message="Este campo es requerido" outlined emit-value map-options dense v-model="form.church" option-value="_id" option-label="name" :options="churchs" />
          </div>
        </div>
